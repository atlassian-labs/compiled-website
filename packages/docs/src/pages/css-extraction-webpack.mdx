...
We recommend only extracting when building your application for production.
If you're building your design system or component library your consumers should extract instead.
