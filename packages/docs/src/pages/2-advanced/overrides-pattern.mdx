...
You could give theming a go and have either CSS variables consumers can modify to change how an element looks,
or you could allow a subset of CSS to be passed down to be set as inline styles or props on your compiled css.
