...
Testing is important for long-lived projects,
and something that Compiled was developed with in mind.

Use the [Jest matcher](https://jestjs.io/docs/en/using-matchers) when writing unit tests to assert style behaviour over state changes.
