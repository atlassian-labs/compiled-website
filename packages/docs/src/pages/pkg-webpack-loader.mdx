...
As a performance optimization you can include specific files and directories by [passing a webpack condition](https://webpack.js.org/configuration/module/#condition) to the plugin.
...
As a performance optimization you can exclude specific files and directories by [passing a webpack condition](https://webpack.js.org/configuration/module/#condition) to the plugin.
