...
Conditionally apply [CSS rules](https://developer.mozilla.org/en-US/docs/Learn/CSS/First_steps/How_CSS_is_structured#Selectors). Both conditional (ternary syntax) and logical expressions are
supported.

### With Array prop
<CssPropConditionalRulesArray />
